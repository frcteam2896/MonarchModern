...
function bones_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_style( 'bones-stylesheet', get_stylesheet_directory_uri() . '/library/style/style.php', array(), '', 'all' );

    // ie-only style sheet
    wp_register_style( 'bones-ie-only', get_stylesheet_directory_uri() . '/library/style/ie.php', array(), '' );
...
add_action( 'init', 'bones_theme_support' );/* end bones theme support */
